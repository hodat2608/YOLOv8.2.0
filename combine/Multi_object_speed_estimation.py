...
#     run(source=source, view_img=False, save_img=True, actual_localtion_estimation=False, speed_estimation=False)
...
def show(self,n,frame_video):
    path = f"ultralytics_source_output/exp{n}/*.mp4"
    ...
    if ret:
        ...
        frame_video.config(image=imgtk)
        frame_video.after(10,self.show)