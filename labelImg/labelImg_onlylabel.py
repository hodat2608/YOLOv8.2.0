# label_want_show = ['cacbon','buichi','divat','taychoi','chaudien','vunchi','2','3','4','6','7','9','10']
# label_want_show = ['buichi']
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        self.actions.beginner = (pyautogui.hotkey('ctrl', 'h'),
    ...
    def add_label(self, shape):
        self.display_label_option.setCheckable(False)
    ...
    def add_zoom(self, increment=10):
        if increment > 0:
            self.set_zoom(self.zoom_widget.value() + 75)
        elif increment < 0:
            self.set_zoom(self.zoom_widget.value() - 75)
    ...
    def toggle_polygons(self, value):
        for item, shape in self.items_to_shapes.items():
            if shape.label not in label_want_show:
